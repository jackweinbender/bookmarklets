(function () {
    ...
    fetch("https://namey.muffinlabs.com/name.json?count=1&with_surname=true&frequency=all")
        ...
        const username = `${firstname.slice(0, 1)}${lastname}+${hash}@example.com`.toLowerCase();
